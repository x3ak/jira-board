        ...
        execute: function() {
            IssueService = (function () {
                function IssueService(http) {
                    ...
                    this._url = 'http://jira-report.cloud.rdlp/api-proxy.php/search?maxResults=200&fields=' + this._fields + '&jql=project = RDLP AND fixVersion in (7.0.0.0, 6.14.0.0) and status != Closed ORDER BY status ASC, fixVersion ASC, priority DESC, key DESC';
                }
