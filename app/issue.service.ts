...
export class IssueService {
    ...
    private _url = 'http://jira-report.cloud.rdlp/api-proxy.php/search?maxResults=200&fields=' + this._fields + '&jql=project = RDLP AND fixVersion in (7.0.0.0, 6.14.0.0) and status != Closed ORDER BY fixVersion ASC, priority DESC, status ASC,  key DESC';
